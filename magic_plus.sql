...
--
-- Host: localhost    Database: magic_plus
-- ------------------------------------------------------
...
CREATE TABLE `ussd` (
  ...
  `timeinitiated` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- Dump completed on 2016-05-08 16:32:35
